...
set.seed(1)
cv_model <- train(quality_binary ~ . - quality, data = wine_df, method = "glm", family = binomial, trControl = control)
...
set.seed(1)
multi_model_cv <- train(quality ~ ., data = wine_df, method = "multinom", trControl = control2)
